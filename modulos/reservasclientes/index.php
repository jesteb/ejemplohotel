      ...
      <a class="boton"  href="index.php?pagina=<?php echo $pagina; ?>&accion=nuevo" title="reserva">Nueva Reserva:</a>
        <table id="tabla" >
            ...
            <?php
                ...
                $lista =  mysql_query("SELECT r.localizador,r.id_habitacion,fecha_entrada,fecha_salida,t.valor,c.nombre,c.apellidos 
                  from reservas r, clientes c, tarifas t, habitaciones h WHERE h.tarifa=t.id_tarifa and c.dni=r.dni and h.id_habitacion=r.id_habitacion and c.dni='".$id_usuario."' order by 3");
