...
class PHPMailer {
  ...
  function SecureHeader($str) {
	...
	/*
	   ARCHIVO -> INDICA QUE FICHERO UTILIZAR
	   VARIABLES -> PERMITE DEFINIR LA VARIABLESA REEMPLAZAR
	   DATOS -> PERMITE ENVIOS DE DATOS DE EMAIL
	   EMAIL -> email['email'] = direccion de envio
	   email['asunto'] = "asunto"
	*/
